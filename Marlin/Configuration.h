...
// changed to FALSE to support auto leveling.
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 162
    #define BACK_PROBE_BED_POSITION 133
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -18.2
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -47.7
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -10.9

  #define Z_RAISE_BEFORE_HOMING 11       // (in mm) Raise Z before homing (G28) for Probe Clearance.
                                        // Be sure you have this distance over your Z_MAX_POS in case

  #define XY_TRAVEL_SPEED 6000         // X and Y axis travel speed between probes, in mm/min. Default = 8000
  ...
  // Disable servo after 'x' milliseconds. This will stop jitter.  Perhaps should be some "pull up" resister in the circuit instead?
  // I have seen reports of servos failing after a small number of print hours if jitter is not stopped.
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/1.25,604.941819095}      // original dealuts from Joco
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.30569,79.72,2535.1,606.44443407945007}
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 134,24} // X,Y,Z Axis Extend and Retract angles
